...
| 013 | privacy_optimization.ps1 | v1.1.2 | 개인정보 보호 강화 (위치 서비스, 권한 설정, 동기화 비활성화, **OrchestrateMode Explorer 체크**) |
| 014 | storage_optimization.ps1 | v1.1.2 | Storage Sense 활성화, 자동 정리 설정 (**OrchestrateMode Explorer 체크**) |
